...
use super::types::PolynomialSize;
use bytemuck::cast_slice_mut;
use concrete_core::commons::math::torus::FromTorus;
...
fn convert_add_backward_torus_u64_scalar(
    ...
    for (out_re, out_im, &inp, &w_re, &w_im) in izip!(out_re, out_im, inp, twisties.re, twisties.im)
    {
        ...
        *out_re = out_re.wrapping_add(u64::from_torus(tmp_re));
        *out_im = out_im.wrapping_add(u64::from_torus(tmp_im));
    }
}
...
fn convert_backward_torus_u64(
    ...
    izip!(out_re, out_im, inp, twisties.re, twisties.im).for_each(
        |(out_re, out_im, inp, w_re, w_im)| {
            ...
            out_re.write(u64::from_torus(tmp_re));
            out_im.write(u64::from_torus(tmp_im));
        },
    );
}
