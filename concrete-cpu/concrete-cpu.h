...
void concrete_cpu_circuit_bootstrap_boolean_vertical_packing_lwe_ciphertext_u64(uint64_t *ct_out_vec,
                                                                                ...
                                                                                size_t ct_in_count,
                                                                                size_t small_lut_count,
                                                                                size_t small_lut_size,
...
void concrete_cpu_init_lwe_bootstrap_key_u64(uint64_t *lwe_bsk,
                                             uint64_t *input_lwe_sk,
                                             uint64_t *output_glwe_sk,
                                             size_t input_lwe_dimension,
                                             size_t output_poly_size,
...
void concrete_cpu_init_lwe_packing_keyswitch_key_u64(uint64_t *lwe_pksk,
                                                     uint64_t *input_lwe_sk,
                                                     uint64_t *output_glwe_sk,
                                                     size_t input_lwe_dimension,
                                                     size_t output_poly_size,
...
ScratchStatus concrete_cpu_keyswitch_lwe_ciphertext_u64_scratch(size_t *stack_size,
                                                                size_t *stack_align,
                                                                size_t decomposition_level_count,
                                                                size_t decomposition_base_log,
                                                                size_t input_dimension,
