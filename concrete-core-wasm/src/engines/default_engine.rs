...
impl DefaultEngine {
    ...
    pub fn create_encoder_f64_min_max(&mut self, config: &JsValue) -> JsResult<FloatEncoder> {
        ...
        let config: Config = config.into_serde().expect("Should provide a proper map.");
    ...
    pub fn encoder_cleartext_f64_32(
        &mut self,
    ...
    pub fn encoder_cleartext_f64_64(
        &mut self,
        encoder: &FloatEncoder,
        cleartext: &CleartextF64,
    ...
    pub fn encode_cleartext_vector_32(
        &mut self,
    ...
    pub fn encode_cleartext_vector_64(
        &mut self,
        encoder_vector: &FloatEncoderVector,
        cleartext_vector: &CleartextVectorF64,
    ...
    pub fn decode_plaintext_32_f64(
        &mut self,
        encoder: &FloatEncoder,
    ...
    pub fn decode_plaintext_64_f64(
        &mut self,
        encoder: &FloatEncoder,
    ...
    pub fn decode_plaintext_vector_32_f64(
        &mut self,
        encoder_vector: &FloatEncoderVector,
    ...
    pub fn decode_plaintext_vector_64_f64(
        &mut self,
        encoder_vector: &FloatEncoderVector,
