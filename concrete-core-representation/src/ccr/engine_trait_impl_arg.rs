...
pub enum EngineTraitImplArg {
    ...
    OwnedEntity(syn::PatIdent, syn::Type, syn::Ident),
    ...
    #[serde(serialize_with = "serialize_with_token_string_3")]
    ViewEntity(syn::PatIdent, syn::Type, syn::Ident),
    ...
    #[serde(serialize_with = "serialize_with_token_string_3")]
    MutViewEntity(syn::PatIdent, syn::Type, syn::Ident),
    ...
    #[serde(serialize_with = "serialize_with_token_string_3")]
    Config(syn::PatIdent, syn::Type, syn::Ident),
    ...
    #[serde(serialize_with = "serialize_with_token_string_3")]
    Parameter(syn::PatIdent, syn::Type, syn::Ident),
    // The argument is a commons dispersion.
    #[serde(serialize_with = "serialize_with_token_string_3")]
    Dispersion(syn::PatIdent, syn::Type, syn::Ident),
    // The argument is a rust numeric type passed by value.
    #[serde(serialize_with = "serialize_with_token_string_3")]
    Numeric(syn::PatIdent, syn::Type, syn::Ident),
