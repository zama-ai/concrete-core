use crate::commons::math::decomposition::{SignedDecompositionIter, TensorSignedDecompositionIter};
    ...
    Scalar: UnsignedInteger,
{
    ...
    /// use concrete_core::prelude::{DecompositionBaseLog, DecompositionLevelCount};
    /// let decomposer =
