...
macro_rules! tensor_traits {
    ($Type:ident) => {
        impl<Element, Cont> $crate::commons::math::tensor::AsRefTensor
            for $Type<Cont>
        where
        ...
        impl<Element, Cont> $crate::commons::math::tensor::AsMutTensor
            for $Type<Cont>
        where
            Cont: $crate::commons::math::tensor::AsMutSlice<Element = Element>,
        {
            ...
            fn as_mut_tensor(
                ...
                <Self as $crate::commons::math::tensor::AsMutTensor>::Container,
            > {
                &mut self.tensor
            }
        }
        ...
        {
            type Element =
                <Cont as $crate::commons::math::tensor::AsRefSlice>::Element;
            type Container = Cont;
