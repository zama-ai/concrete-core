...
use crate::prelude::{GlweDimension, GlweSize, MonomialDegree, PolynomialSize};
...
impl<Cont> GlweCiphertext<Cont> {
    ...
    /// use concrete_core::prelude::{GlweDimension, LogStandardDev, LweDimension, PolynomialSize};
