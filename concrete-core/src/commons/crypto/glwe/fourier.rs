...
use crate::commons::math::fft::{Complex64, FourierPolynomial};
...
impl<Scalar> FourierGlweCiphertext<AlignedVec<Complex64>, Scalar> {
    ...
    /// ```
    /// use concrete_commons::parameters::{GlweSize, PolynomialSize};
    /// use concrete_core::commons::crypto::glwe::FourierGlweCiphertext;
...
impl<Cont, Scalar: UnsignedTorus> FourierGlweCiphertext<Cont, Scalar> {
    ...
    /// ```
    /// use concrete_commons::parameters::{GlweSize, PolynomialSize};
    /// use concrete_core::commons::crypto::bootstrap::FourierBuffers;
    /// use concrete_core::commons::crypto::glwe::{FourierGlweCiphertext, GlweCiphertext};
    /// use concrete_core::commons::math::fft::Complex64;
    ///
    ...
    /// ```
    /// use concrete_commons::parameters::PolynomialSize;
    /// use concrete_core::commons::math::polynomial::{MonomialDegree, PolynomialList};
    /// let mut list =
    ///     PolynomialList::from_container(vec![1u8, 2, 3, 4, 5, 6, 7, 8], PolynomialSize(2));
