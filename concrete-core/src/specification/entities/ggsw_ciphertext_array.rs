...
use crate::specification::entities::markers::GgswCiphertextArrayKind;
use crate::specification::entities::AbstractEntity;

/// A trait implemented by types embodying a GGSW ciphertext array.
///
/// # Formal Definition
///
/// cf [`here`](`crate::specification::entities::GgswCiphertextEntity`)
pub trait GgswCiphertextArrayEntity: AbstractEntity<Kind = GgswCiphertextArrayKind> {
