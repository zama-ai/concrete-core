...
/// A trait implemented by types embodying a seeded GLWE ciphertext array.
///
...
pub trait GlweSeededCiphertextArrayEntity:
    AbstractEntity<Kind = GlweSeededCiphertextArrayKind>
{
