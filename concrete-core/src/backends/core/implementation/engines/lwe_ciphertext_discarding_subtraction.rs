...
/// # Description:
/// Implementation of [`LweCiphertextDiscardingSubtractionEngine`] for [`CoreEngine`] that operates on
/// 32 bits integers.
impl LweCiphertextDiscardingSubtractionEngine<LweCiphertext32, LweCiphertext32> for CoreEngine {
    ...
    unsafe fn discard_sub_lwe_ciphertext_unchecked(
        ...
        output.0.update_with_sub(&input_1.0);
