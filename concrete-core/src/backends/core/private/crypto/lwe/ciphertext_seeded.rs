...
impl<Scalar> LweSeededCiphertext<Scalar> {
    ...
    /// use concrete_commons::parameters::{LweDimension, LweSize};
    /// use concrete_core::backends::core::private::crypto::lwe::LweSeededCiphertext;
    /// let ct = LweSeededCiphertext::from_scalar(0 as u8, LweDimension(3), 0, 0);
    /// assert_eq!(ct.lwe_size(), LweSize(4));
    /// ```
    pub fn from_scalar(
        value: Scalar,
    ...
    /// Returns the shift of the ciphertext.
    ...
    /// let ciphertext = LweSeededCiphertext::from_scalar(0 as u8, LweDimension(3), 0, 0);
    ...
    /// use concrete_commons::parameters::LweDimension;
    /// use concrete_core::backends::core::private::crypto::lwe::{LweBody, LweSeededCiphertext};
    /// let mut ciphertext = LweSeededCiphertext::from_scalar(0 as u8, LweDimension(3), 0, 0);
    ...
    /// };
    /// let seeded_ciphertext = LweSeededCiphertext::allocate(0 as u8, LweDimension(9));
