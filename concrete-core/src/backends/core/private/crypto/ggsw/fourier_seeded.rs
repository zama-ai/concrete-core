...
impl<Cont, Scalar> FourierGgswSeededCiphertext<Cont, Scalar> {
    ...
    ///
    /// let mut ggsw: FourierGgswSeededCiphertext<_, u32> = FourierGgswSeededCiphertext::allocate(
    ///     Complex64::new(0., 0.),
    ///     PolynomialSize(10),
    ///     GlweSize(7),
    ///     DecompositionLevelCount(3),
    ...
    /// };
    /// use concrete_core::backends::core::private::math::fft::Complex64;
    /// let seeded_ggsw: FourierGgswSeededCiphertext<_, u32> = FourierGgswSeededCiphertext::allocate(
    ///     Complex64::new(0., 0.),
    ///     PolynomialSize(256),
    ///     GlweSize(7),
    ///     DecompositionLevelCount(3),
