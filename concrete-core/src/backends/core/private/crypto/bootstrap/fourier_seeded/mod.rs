    ...
    Scalar: UnsignedTorus,
{
    ...
    /// let mut bsk: FourierSeededBootstrapKey<_, u32> = FourierSeededBootstrapKey::allocate(
    ///     Complex64::new(9., 8.),
    ///     GlweSize(7),
    ///     PolynomialSize(256),
    ///     DecompositionLevelCount(3),
    ...
    /// };
    /// use concrete_core::backends::core::private::math::fft::Complex64;
    /// let seeded_bsk: FourierSeededBootstrapKey<_, u32> = FourierSeededBootstrapKey::allocate(
    ///     Complex64::new(9., 8.),
    ///     GlweSize(7),
    ///     PolynomialSize(256),
    ///     DecompositionLevelCount(3),
