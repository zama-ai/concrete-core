...
#[cfg_attr(feature = "serde_serialize", derive(Serialize, Deserialize))]
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct GlweTensorProductSecretKey32(pub(crate) ImpGlweSecretKey<TensorProductKeyKind, 
    Vec<u32>>);
...
#[cfg_attr(feature = "serde_serialize", derive(Serialize, Deserialize))]
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct GlweTensorProductSecretKey64(pub(crate) ImpGlweSecretKey<TensorProductKeyKind, Vec<u64>>);
