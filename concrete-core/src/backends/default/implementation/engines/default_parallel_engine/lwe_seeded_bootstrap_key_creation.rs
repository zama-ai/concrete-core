...
use crate::backends::default::implementation::engines::DefaultParallelEngine;
...
/// # Description:
/// Implementation of [`LweSeededBootstrapKeyCreationEngine`] for [`DefaultParallelEngine`] that
    ...
    for DefaultParallelEngine
{
    ...
    ///     .create_lwe_seeded_bootstrap_key(&lwe_sk, &glwe_sk, dec_bl, dec_lc, noise)?;
    /// #
