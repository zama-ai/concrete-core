...
use crate::prelude::{GlweTensorProductCiphertext32, GlweTensorProductCiphertext64, GlweTensorProductSecretKey32, GlweTensorProductSecretKey64};
...
/// # Description:
/// Implementation of [`GlweCiphertextDecryptionEngine`] for [`DefaultEngine`] that operates on 32
/// bits integers GLWE ciphertexts that are the output of a tensor product.
impl GlweCiphertextDecryptionEngine<GlweTensorProductSecretKey32, GlweTensorProductCiphertext32, 
    PlaintextVector32>
for DefaultEngine
{
    /// # Example:
    ...
    /// let ciphertext = engine.encrypt_glwe_ciphertext(&key, &plaintext_vector, noise)?;
    ///
    /// // Here a tensor product should be performed, it is not implemented in the default 
    ...
    fn decrypt_glwe_ciphertext(
        &mut self,
        key: &GlweTensorProductSecretKey32,
...
/// Implementation of [`GlweCiphertextDecryptionEngine`] for [`DefaultEngine`] that operates on 64
/// bits integers GLWE ciphertexts that are the output of a tensor product.
impl GlweCiphertextDecryptionEngine<GlweTensorProductSecretKey64, GlweTensorProductCiphertext64, 
    PlaintextVector64>
for DefaultEngine
{
    /// # Example:
    ...
    fn decrypt_glwe_ciphertext(
        &mut self,
        key: &GlweTensorProductSecretKey64,
