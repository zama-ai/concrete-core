...
use crate::specification::engines::{
    LweCiphertextArrayDiscardingAdditionEngine, LweCiphertextArrayDiscardingAdditionError,
};

/// # Description:
/// Implementation of [`LweCiphertextArrayDiscardingAdditionEngine`] for [`DefaultEngine`]
/// that operates on 32 bits integers.
impl LweCiphertextArrayDiscardingAdditionEngine<LweCiphertextArray32, LweCiphertextArray32>
    for DefaultEngine
{
    /// # Example:
    /// ```
    ...
    ///
    /// engine.discard_add_lwe_ciphertext_array(
    ...
    fn discard_add_lwe_ciphertext_array(
        ...
        LweCiphertextArrayDiscardingAdditionError::perform_generic_checks(
            output, input_1, input_2,
        )?;
        unsafe { self.discard_add_lwe_ciphertext_array_unchecked(output, input_1, input_2) };
        Ok(())
    }
...
impl LweCiphertextArrayDiscardingAdditionEngine<LweCiphertextArray64, LweCiphertextArray64>
    for DefaultEngine
{
    /// # Example:
    /// ```
