...
use crate::prelude::{
    ...
    LweCiphertextVector64Version, LweCiphertextVectorEntity, LweCiphertextVectorMutView64,
    LweCiphertextVectorView64, LweCiphertextView32, LweCiphertextView64, LweKeyswitchKey32,
    ...
    for DefaultSerializationEngine
{
    ...
    ///     engine.create_lwe_ciphertext_vector(raw_ciphertext_vector.as_slice(), lwe_size)?;
    ...
    for DefaultSerializationEngine
{
    ...
    ///     engine.create_lwe_ciphertext_vector(raw_ciphertext_vector.as_mut_slice(), lwe_size)?;
