...
#[test]
pub fn test_cuda_woppbs_cmux_tree() {
...
#[test]
pub fn test_cuda_woppbs_extract_bits() {
...
// #[test]
// pub fn test_cuda_woppbs_extract_bit_circuit_bootstrapping_cuda_vertical_packing() {
//     // define settings
//     let polynomial_size = PolynomialSize(1024);
//     let glwe_dimension = GlweDimension(1);
//     let lwe_dimension = LweDimension(583);
//
//     let level_bsk = DecompositionLevelCount(2);
//     let base_log_bsk = DecompositionBaseLog(15);
//
//     let level_pksk = DecompositionLevelCount(1);
//     let base_log_pksk = DecompositionBaseLog(25);
//
//     let level_ksk = DecompositionLevelCount(3);
//     let base_log_ksk = DecompositionBaseLog(3);
//
...
//
//     let mut secret_generator =
// SecretRandomGenerator::<SoftwareRandomGenerator>::new(seeder.seed());     let mut
// encryption_generator =         EncryptionRandomGenerator::<SoftwareRandomGenerator>::new(seeder.
// seed(), &mut seeder);
//
...
//
//     // Here even thought the deltas have the same value, they can differ between ciphertexts and
// lut     // so keeping both separate
...
//         let decoded_message = decomposer.closest_representable(decrypted_message.0) >>
// delta_log.0;
//
...
#[test]
fn test_cuda_woppbs_circuit_bootstrapping_binary() {
    // Define settings for an insecure toy example
    let polynomial_size = PolynomialSize(512);
    let glwe_dimension = GlweDimension(2);
    ...
    let mut d_fp_ksk_array = stream.malloc::<u64>(
        (glwe_dimension.0 as u32 * polynomial_size.0 as u32 + 1)
            * (glwe_dimension.0 as u32 + 1)
            * (glwe_dimension.0 as u32 + 1)
            * level_pksk.0 as u32
            * polynomial_size.0 as u32,
