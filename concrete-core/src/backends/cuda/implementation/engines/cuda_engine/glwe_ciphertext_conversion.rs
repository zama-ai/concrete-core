...
/// # Description
/// Convert a GLWE ciphertext array with 32 bits of precision from GPU 0 to CPU.
...
/// # Description
/// Convert a GLWE ciphertext array with 64 bits of precision from GPU 0 to CPU.
/// This conversion is not necessary to run the bootstrap on the GPU.
/// It is implemented for testing purposes only.
