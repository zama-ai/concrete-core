...
use crate::backends::cuda::private::crypto::bootstrap::execute_lwe_ciphertext_array_amortized_bootstrap_on_gpu;
    ...
    > for AmortizedCudaEngine
{
    ...
    /// cuda_amortized_engine.discard_bootstrap_lwe_ciphertext_array(
    ...
    unsafe fn discard_bootstrap_lwe_ciphertext_array_unchecked(
        ...
        execute_lwe_ciphertext_array_amortized_bootstrap_on_gpu::<u32>(
    ...
    > for AmortizedCudaEngine
{
    ...
    unsafe fn discard_bootstrap_lwe_ciphertext_array_unchecked(
        ...
        execute_lwe_ciphertext_array_amortized_bootstrap_on_gpu::<u64>(
            self.get_cuda_streams(),
            &mut output.0,
            &input.0,
            &acc.0,
