...
use crate::prelude::{BinaryTensorProductKeyKind, GlweDimension, KeyKind, PolynomialSize};
    ...
    Kind: KeyKind,
{
    ...
    ///         PolynomialSize(10),
    ///     );
    /// assert_eq!(glwe_key.glwe_dimension(), GlweDimension(7));
    /// assert_eq!(glwe_key.polynomial_size(), PolynomialSize(10));
    /// ```
    ...
    ///     fourier_glwe_key.poly_size,
    ///     fourier_glwe_key.glwe_dimension().to_glwe_size(),
    /// );
    ///
    ...
    ///
    /// let mut buffers = FourierBuffers::new(
    ///     fourier_glwe.poly_size,
    ///     fourier_glwe.glwe_dimension().to_glwe_size(),
    /// );
    /// let mut buffers_out = FourierBuffers::new(
    ///     fourier_glwe.poly_size,
    ///     fourier_glwe.glwe_dimension().to_glwe_size(),
    /// );
    ///
    ...
    pub fn create_tensor_product_key(
        &self,
    ) -> FourierGlweSecretKey<BinaryTensorProductKeyKind, AlignedVec<Complex64>, Scalar>
    where
