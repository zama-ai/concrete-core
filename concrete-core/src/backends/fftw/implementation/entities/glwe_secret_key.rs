...
pub struct FftwFourierGlweTensorProductSecretKey32(pub(crate) 
                                               FourierGlweSecretKey<TensorProductKeyKind, 
                                                   AlignedVec<Complex64>, u32>);
...
#[cfg_attr(feature = "serde_serialize", derive(Serialize, Deserialize))]
#[derive(Debug, Clone, PartialEq)]
pub struct FftwFourierGlweTensorProductSecretKey64(pub(crate) FourierGlweSecretKey<TensorProductKeyKind, AlignedVec<Complex64>, u64>);
