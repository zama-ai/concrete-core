    ...
    > for FftwEngine
{
    ...
    /// let ciphertext_1 = default_engine.encrypt_glwe_ciphertext(&key, &plaintext_vector_1, 
    /// noise)?;
    /// let ciphertext_2 = default_engine.encrypt_glwe_ciphertext(&key, &plaintext_vector_2, 
    /// noise)?;
    ///
    ...
    ///
    /// assert_eq!(tensor_product_ciphertext.glwe_dimension(), glwe_dimension);
    ...
    unsafe fn tensor_product_glwe_ciphertext_same_key_unchecked(
        ...
        FftwFourierGlweTensorProductCiphertext32(
            fourier1
                .0
                .tensor_product_same_key(&fourier2.0, scale),
        )
    }
}
...
> for FftwEngine
{
    ...
    /// // The result is in the Fourier domain
    /// let tensor_product_ciphertext = fftw_engine.tensor_product_glwe_ciphertext_same_key
    /// (&fourier_ciphertext_1, &fourier_ciphertext_2)?;
    ///
    /// assert_eq!(tensor_product_ciphertext.glwe_dimension(), glwe_dimension);
    /// assert_eq!(tensor_product_ciphertext.polynomial_size(), polynomial_size);
    ///
    ...
    unsafe fn tensor_product_glwe_ciphertext_same_key_unchecked(
        ...
        FftwFourierGlweTensorProductCiphertext32(
            input1
                .0
                .tensor_product_same_key(&input2.0, scale),
        )
    }
}
