...
use crate::prelude::{FftwFourierGlweTensorProductSecretKey32, FftwFourierGlweTensorProductSecretKey64, GlweDimension, GlweSecretKey32, GlweSecretKey64, GlweSecretKeyEntity, GlweSecretKeyTensorProductSameKeyEngine, GlweSecretKeyTensorProductSameKeyError};
...
impl GlweSecretKeyTensorProductSameKeyEngine<GlweSecretKey32, 
    FftwFourierGlweTensorProductSecretKey32> for FftwEngine {
    /// # Example
    /// ```
    ...
    /// let tensor_product_key = fftw_engine.tensor_product_glwe_secret_key_same_key
    /// (&key)?;
    ///
    ...
    ) -> Result<FftwFourierGlweTensorProductSecretKey32, 
...
/// secret key with itself in the standard domain.
impl GlweSecretKeyTensorProductSameKeyEngine<GlweSecretKey64, FftwFourierGlweTensorProductSecretKey64> for FftwEngine {
    /// # Example
    /// ```
    /// use concrete_commons::dispersion::Variance;
    /// use concrete_commons::parameters::{
    ...
    ) -> Result<FftwFourierGlweTensorProductSecretKey64, GlweSecretKeyTensorProductSameKeyError<Self::EngineError>> {
        Ok(unsafe { self.create_tensor_product_glwe_secret_key_same_key_unchecked(input) })
    }
