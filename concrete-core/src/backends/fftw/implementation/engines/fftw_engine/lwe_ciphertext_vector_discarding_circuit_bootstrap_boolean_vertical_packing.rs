...
use crate::backends::fftw::private::crypto::wop_pbs::circuit_bootstrap_boolean_vertical_packing;
...
impl From<FftwError>
    for LweCiphertextVectorDiscardingCircuitBootstrapBooleanVerticalPackingError<FftwError>
{
    ...
    > for FftwEngine
{
    ...
    /// )?;
    ///
    /// let fourier_bsk: FftwFourierLweBootstrapKey32 =
    ///     fftw_engine.convert_lwe_bootstrap_key(&std_bsk)?;
    ///
