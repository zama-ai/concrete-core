...
use crate::prelude::{
    ...
    GlweCiphertext32, GlweCiphertext64, GlweTensorProductCiphertext32,
    ...
    > for FftwEngine
{
    ...
    /// let ciphertext_out: GlweTensorProductCiphertext32 =
    ///     fftw_engine.convert_glwe_ciphertext(&tensor_product_ciphertext)?;
    ///
    /// assert_eq!(
    ///     ciphertext_out.glwe_dimension(),
    ...
    > for FftwEngine
{
    ...
    /// )?;
    /// // Then we convert the result back to the standard domain.
    /// let ciphertext_out: GlweTensorProductCiphertext64 =
    ///     fftw_engine.convert_glwe_ciphertext(&tensor_product_ciphertext)?;
    ///
    /// assert_eq!(
    ///     ciphertext_out.glwe_dimension(),
