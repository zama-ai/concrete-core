    ...
    if Precision::Raw::BITS == 32 {
        [
            LweCiphertextVectorDiscardingCircuitBootstrapBooleanVerticalPackingParameters {
                ...
                decomp_level_count_bsk: DecompositionLevelCount(5),
                decomp_base_log_bsk: DecompositionBaseLog(6),
                decomp_level_count_pfpksk: DecompositionLevelCount(5),
                decomp_base_log_pfpksk: DecompositionBaseLog(6),
                decomp_level_count_cbs: DecompositionLevelCount(5),
