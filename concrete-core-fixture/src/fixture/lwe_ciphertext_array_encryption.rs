use concrete_core::prelude::{
    LweCiphertextArrayEncryptionEngine, LweCiphertextArrayEntity, LweCiphertextCount, LweDimension,
...
/// A fixture for the types implementing the `LweCiphertextArrayEncryptionEngine` trait.
pub struct LweCiphertextArrayEncryptionFixture;

#[derive(Debug)]
pub struct LweCiphertextArrayEncryptionParameters {
    pub noise: Variance,
...
impl<Precision, KeyDistribution, Engine, PlaintextArray, SecretKey, CiphertextArray>
    ...
    for LweCiphertextArrayEncryptionFixture
where
    Precision: IntegerPrecision,
    KeyDistribution: KeyDistributionMarker,
    Engine: LweCiphertextArrayEncryptionEngine<SecretKey, PlaintextArray, CiphertextArray>,
...
{
    type Parameters = LweCiphertextArrayEncryptionParameters;
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![
                LweCiphertextArrayEncryptionParameters {
    ...
    fn execute_engine(
        ...
        let ciphertext_array = unsafe {
            engine.encrypt_lwe_ciphertext_array_unchecked(
                &secret_key,
                &plaintext_array,
                parameters.noise,
            )
