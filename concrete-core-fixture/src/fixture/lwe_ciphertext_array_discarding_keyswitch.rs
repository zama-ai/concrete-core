...
use crate::generation::prototyping::{
    PrototypesLweCiphertextArray, PrototypesLweKeyswitchKey, PrototypesLweSecretKey,
    PrototypesPlaintextArray,
};
use crate::generation::synthesizing::{SynthesizesLweCiphertextArray, SynthesizesLweKeyswitchKey};
use crate::generation::{IntegerPrecision, KeyDistributionMarker, Maker};
use crate::raw::generation::RawUnsignedIntegers;
use crate::raw::statistical_test::assert_noise_distribution;
use concrete_core::prelude::{
    DecompositionBaseLog, DecompositionLevelCount, DispersionParameter, LogStandardDev,
    LweCiphertextArrayDiscardingKeyswitchEngine, LweCiphertextArrayEntity, LweCiphertextCount,
    LweDimension, LweKeyswitchKeyEntity, Variance,
};

/// A fixture for the types implementing the `LweCiphertextArrayDiscardingKeyswitchEngine` trait.
pub struct LweCiphertextArrayDiscardingKeyswitchFixture;

#[derive(Debug)]
pub struct LweCiphertextArrayDiscardingKeyswitchParameters {
    pub n_bit_msg: usize,
...
impl<
    ...
    Fixture<
        ...
        Engine,
        (KeyswitchKey, InputCiphertextArray, OutputCiphertextArray),
    > for LweCiphertextArrayDiscardingKeyswitchFixture
where
    Precision: IntegerPrecision,
    InputKeyDistribution: KeyDistributionMarker,
    OutputKeyDistribution: KeyDistributionMarker,
    Engine: LweCiphertextArrayDiscardingKeyswitchEngine<
        KeyswitchKey,
        InputCiphertextArray,
        OutputCiphertextArray,
    >,
...
{
    type Parameters = LweCiphertextArrayDiscardingKeyswitchParameters;
    ...
    type PreExecutionContext = (OutputCiphertextArray, InputCiphertextArray, KeyswitchKey);
    type PostExecutionContext = (OutputCiphertextArray, InputCiphertextArray, KeyswitchKey);
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![
                LweCiphertextArrayDiscardingKeyswitchParameters {
                    n_bit_msg: 8,
    ...
    fn generate_random_sample_prototypes(
        ...
        let raw_plaintext_array = Precision::Raw::uniform_n_msb_vec(
    ...
    fn execute_engine(
        ...
        let (mut output_ciphertext_array, input_ciphertext_array, keyswitch_key) = context;
        unsafe {
            engine.discard_keyswitch_lwe_ciphertext_array_unchecked(
    ...
    fn process_context(
        ...
        let (output_ciphertext_array, input_ciphertext_array, keyswitch_key) = context;
