...
use concrete_core::prelude::{
    ...
    LweDimension, LweSecretKeyEntity, LweSeededBootstrapKeyEntity,
    LweSeededBootstrapKeyGenerationEngine, PolynomialSize, Variance,
};

/// A fixture for the types implementing the `LweSeededBootstrapKeyGenerationEngine` trait.
pub struct LweSeededBootstrapKeyGenerationFixture;

#[derive(Debug)]
pub struct LweSeededBootstrapKeyGenerationParameters {
...
impl<
    ...
    > for LweSeededBootstrapKeyGenerationFixture
where
    Precision: IntegerPrecision,
    InputKeyDistribution: KeyDistributionMarker,
    OutputKeyDistribution: KeyDistributionMarker,
    Engine: LweSeededBootstrapKeyGenerationEngine<LweSecretKey, GlweSecretKey, SeededBootstrapKey>,
    ...
    Maker: SynthesizesLweSecretKey<Precision, InputKeyDistribution, LweSecretKey>
        ...
        >,
{
    type Parameters = LweSeededBootstrapKeyGenerationParameters;
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![
                LweSeededBootstrapKeyGenerationParameters {
    ...
    fn execute_engine(
        ...
        let sk = unsafe {
            engine.generate_new_lwe_seeded_bootstrap_key_unchecked(
                &sk_in,
                &sk_out,
                parameters.base_log,
                parameters.level,
