...
use concrete_core::prelude::{
    DispersionParameter, LogStandardDev, LweCiphertextArrayDiscardingAdditionEngine,
...
/// A fixture for the types implementing the `LweCiphertextArrayDiscardingAdditionEngine`
/// trait.
pub struct LweCiphertextArrayDiscardingAdditionFixture;

#[derive(Debug)]
pub struct LweCiphertextArrayDiscardingAdditionParameters {
...
impl<Precision, KeyDistribution, Engine, InputCiphertextArray, OutputCiphertextArray>
    ...
    for LweCiphertextArrayDiscardingAdditionFixture
where
    Precision: IntegerPrecision,
    KeyDistribution: KeyDistributionMarker,
    Engine: LweCiphertextArrayDiscardingAdditionEngine<InputCiphertextArray, OutputCiphertextArray>,
...
{
    type Parameters = LweCiphertextArrayDiscardingAdditionParameters;
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![
                LweCiphertextArrayDiscardingAdditionParameters {
    ...
    fn execute_engine(
        ...
        let (input_ciphertext_array1, input_ciphertext_array2, mut output_ciphertext_array) =
            context;
        unsafe {
            engine.discard_add_lwe_ciphertext_array_unchecked(
