use concrete_core::prelude::{
    ...
    GlweCiphertextVectorEntity, GlweDimension, GlweSecretKeyEntity, PlaintextCount,
        ...
        + SynthesizesGlweCiphertextVector<Precision, KeyDistribution, CiphertextVector>,
{
    ...
    (
        ...
        <Maker as PrototypesGlweCiphertextVector<Precision, KeyDistribution>>::GlweCiphertextVectorProto
    );
