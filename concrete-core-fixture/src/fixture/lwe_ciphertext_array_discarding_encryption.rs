use concrete_core::prelude::{
    LweCiphertextArrayDiscardingEncryptionEngine, LweCiphertextArrayEntity, LweCiphertextCount,
...
/// A fixture for the types implementing the `LweCiphertextArrayDiscardingEncryptionEngine` trait.
pub struct LweCiphertextArrayDiscardingEncryptionFixture;

#[derive(Debug)]
pub struct LweCiphertextArrayDiscardingEncryptionParameters {
    pub noise: Variance,
...
impl<Precision, KeyDistribution, Engine, PlaintextArray, SecretKey, CiphertextArray>
    ...
    for LweCiphertextArrayDiscardingEncryptionFixture
where
    Precision: IntegerPrecision,
    KeyDistribution: KeyDistributionMarker,
    Engine:
        LweCiphertextArrayDiscardingEncryptionEngine<SecretKey, PlaintextArray, CiphertextArray>,
...
{
    type Parameters = LweCiphertextArrayDiscardingEncryptionParameters;
    ...
    type PreExecutionContext = (PlaintextArray, SecretKey, CiphertextArray);
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![
                LweCiphertextArrayDiscardingEncryptionParameters {
    ...
    fn generate_random_sample_prototypes(
        ...
        let proto_ciphertext_array = maker.trivially_encrypt_zeros_to_lwe_ciphertext_array(
    ...
    fn prepare_context(
        ...
        let synth_plaintext_array = maker.synthesize_plaintext_array(proto_plaintext_array);
    ...
    fn execute_engine(
        ...
        let (plaintext_array, secret_key, mut ciphertext_array) = context;
        unsafe {
            engine.discard_encrypt_lwe_ciphertext_array_unchecked(
                &secret_key,
        ...
        (plaintext_array, secret_key, ciphertext_array)
    }
    ...
    fn process_context(
        ...
        let (plaintext_array, secret_key, ciphertext_array) = context;
        let (proto_secret_key,) = repetition_proto;
