...
use crate::generation::prototyping::{PrototypesGlweSecretKey, PrototypesLweBootstrapKey, PrototypesLweCiphertextVector, PrototypesLweCircuitBootstrapPrivateFunctionalPackingKeyswitchKeys, PrototypesLweKeyswitchKey, PrototypesLweSecretKey, PrototypesPlaintextVector};
use crate::generation::synthesizing::{SynthesizesLweBootstrapKey, SynthesizesLweCiphertextVector, SynthesizesLweCircuitBootstrapPrivateFunctionalPackingKeyswitchKeys, SynthesizesLweKeyswitchKey, SynthesizesPlaintextVector};
...
use concrete_core::prelude::{BinaryKeyKind, DecompositionBaseLog, DecompositionLevelCount, DeltaLog, DispersionParameter, MessageBitsCount, GaussianKeyKind, GlweDimension, LweBootstrapKeyEntity, LweCiphertextCount, LweCiphertextVectorDiscardingWopPbsEngine, LweCiphertextVectorEntity, LweCircuitBootstrapPrivateFunctionalPackingKeyswitchKeysEntity, LweDimension, PlaintextVectorEntity, PolynomialSize, TernaryKeyKind, Variance, LweKeyswitchKeyEntity, ExtractedBitsCount};
use std::any::TypeId;

/// A fixture for the types implementing the
/// `LweCiphertextVectorDiscardingWopPbsEngine` trait.
pub struct LweCiphertextVectorDiscardingWopPbsFixture;

#[derive(Debug, Clone)]
pub struct LweCiphertextVectorDiscardingWopPbsParameters<
...
fn generate_raw_vec_identity_trivial_lut<Precision: IntegerPrecision>(
    parameters: LweCiphertextVectorDiscardingWopPbsParameters<
        Precision,
    >,
) -> Vec<Precision::Raw> {
...
) -> [LweCiphertextVectorDiscardingWopPbsParameters<Precision>;
       1_usize] {
        [
            LweCiphertextVectorDiscardingWopPbsParameters {
...
impl<
    ...
    > for LweCiphertextVectorDiscardingWopPbsFixture
where
    ...
    Engine: LweCiphertextVectorDiscardingWopPbsEngine<
        InputCiphertextVector,
        OutputCiphertextVector,
        BootstrapKey,
        KeyswitchKey,
        ...
        > + SynthesizesPlaintextVector<Precision, LUTs>,
{
    ...
    fn generate_random_repetition_prototypes(
        ...
        let proto_keyswitch_key = <Maker as PrototypesLweKeyswitchKey<
            Precision,
            BigLweAndGlweKeyDistribution,
            SmallLweKeyDistribution,
    ...
    fn generate_random_sample_prototypes(
        ...
        let (_, proto_small_lwe_sk, _, _, _, proto_lut_plaintext_vector) = repetition_proto;
    ...
    fn prepare_context(
        ...
        let (_, _, proto_bootstrap_key, proto_keyswitch_key, proto_cbs_pfpksk, 
            proto_lut_plaintext_vector) =
            repetition_proto;
    ...
    fn execute_engine(
        ...
        unsafe {
            engine
                .discard_wop_pbs_lwe_ciphertext_vector_unchecked(
                    &mut output_ciphertext_vector,
                    &input_ciphertext_vector,
                    &bootstrap_key,
                    &ksk,
    ...
    fn process_context(
        ...
        let (proto_big_lwe_sk, _, _, _, _, _) = repetition_proto;

        let (output_ciphertext_vector, input_ciphertext_vector, bootstrap_key, ksk, luts, 
            cbs_pfpksk) =
            context;
    ...
    fn compute_criteria(
        ...
        (fix_estimate_wop_pbs_noise::<
            ...
            BinaryKeyDistribution,
        >(
            ExtractedBitsCount(parameters.message_bits_count.0),
