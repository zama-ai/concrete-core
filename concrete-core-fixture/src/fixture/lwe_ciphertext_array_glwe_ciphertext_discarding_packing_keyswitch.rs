...
use crate::generation::prototyping::{
    PrototypesGlweCiphertext, PrototypesGlweSecretKey, PrototypesLweCiphertextArray,
    PrototypesLwePackingKeyswitchKey, PrototypesLweSecretKey, PrototypesPlaintextArray,
};
use crate::generation::synthesizing::{
    SynthesizesGlweCiphertext, SynthesizesLweCiphertextArray, SynthesizesPackingKeyswitchKey,
};
...
use concrete_core::prelude::{
    ...
    GlweDimension, LogStandardDev, LweCiphertextArrayEntity,
    LweCiphertextArrayGlweCiphertextDiscardingPackingKeyswitchEngine, LweCiphertextCount,
    LweDimension, LwePackingKeyswitchKeyEntity, PolynomialSize, Variance,
};

/// A fixture for the types implementing the
/// `LweCiphertextArrayGlweCiphertextDiscardingPackingKeyswitchEngine` trait.
pub struct LweCiphertextArrayGlweCiphertextDiscardingPackingKeyswitchFixture;

#[derive(Debug)]
pub struct LweCiphertextArrayGlweCiphertextDiscardingPackingKeyswitchParameters {
...
impl<
    ...
    > for LweCiphertextArrayGlweCiphertextDiscardingPackingKeyswitchFixture
where
    Precision: IntegerPrecision,
    InputKeyDistribution: KeyDistributionMarker,
    OutputKeyDistribution: KeyDistributionMarker,
    Engine: LweCiphertextArrayGlweCiphertextDiscardingPackingKeyswitchEngine<
        LwePackingKeyswitchKey,
        InputCiphertextArray,
        OutputCiphertext,
    >,
    ...
    Maker: SynthesizesLweCiphertextArray<Precision, InputKeyDistribution, InputCiphertextArray>
        ...
        >,
{
    type Parameters = LweCiphertextArrayGlweCiphertextDiscardingPackingKeyswitchParameters;
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![
                LweCiphertextArrayGlweCiphertextDiscardingPackingKeyswitchParameters {
    ...
    fn execute_engine(
        ...
        let (mut output_ciphertext, input_ciphertext_array, pksk) = context;
        unsafe {
            engine.discard_packing_keyswitch_lwe_ciphertext_array_unchecked(
                &mut output_ciphertext,
                &input_ciphertext_array,
                &pksk,
            );
        };
        (output_ciphertext, input_ciphertext_array, pksk)
    }
