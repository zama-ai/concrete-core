...
use concrete_core::prelude::{
    ...
    LweCiphertextArrayFusingAdditionEngine, LweCiphertextCount, LweDimension, Variance,
};
...
/// A fixture for the types implementing the `LweCiphertextArrayFusingAdditionEngine`
/// trait.
pub struct LweCiphertextArrayFusingAdditionFixture;

#[derive(Debug)]
pub struct LweCiphertextArrayFusingAdditionParameters {
...
impl<Precision, KeyDistribution, Engine, InputCiphertextArray, OutputCiphertextArray>
    ...
    for LweCiphertextArrayFusingAdditionFixture
where
    Precision: IntegerPrecision,
    KeyDistribution: KeyDistributionMarker,
    Engine: LweCiphertextArrayFusingAdditionEngine<InputCiphertextArray, OutputCiphertextArray>,
...
{
    type Parameters = LweCiphertextArrayFusingAdditionParameters;
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![
                LweCiphertextArrayFusingAdditionParameters {
    ...
    fn execute_engine(
        ...
        unsafe {
            engine.fuse_add_lwe_ciphertext_array_unchecked(
