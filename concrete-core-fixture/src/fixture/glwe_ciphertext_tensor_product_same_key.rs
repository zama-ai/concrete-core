...
use crate::generation::prototyping::{PrototypesGlweCiphertext, PrototypesGlweSecretKey, PrototypesPlaintextVector};
use crate::generation::synthesizing::{SynthesizesGlweCiphertext, SynthesizesGlweSecretKey, SynthesizesTensorProductGlweSecretKey};
...
use concrete_core::prelude::{BinaryKeyKind, DispersionParameter, GaussianKeyKind, GlweCiphertextEntity, GlweCiphertextTensorProductSameKeyEngine, GlweSecretKeyEntity, ScalingFactor, TernaryKeyKind};
use std::any::TypeId;
...
impl<Precision, Engine, CiphertextIn1, CiphertextIn2, CiphertextOut, TensorProductKey>
    Fixture<Precision, Engine, (CiphertextIn1, CiphertextIn2, CiphertextOut, TensorProductKey)>
...
where
    ...
    Maker: SynthesizesGlweCiphertext<Precision, CiphertextIn1>
        ...
        + SynthesizesTensorProductGlweSecretKey<Precision, CiphertextIn1::KeyDistribution, 
        TensorProductKey>
...
type Parameters = GlweCiphertextTensorProductSameKeyParameters;
    ...
    fn process_context(
        ...
        let (proto_plaintext_vector1, proto_plaintext_vector2, proto_secret_key) = repetition_proto;
        let (input_ciphertext_1, input_ciphertext_2, output_ciphertext) = 
            context;
        ...
        let output_key = <Maker as SynthesizesTensorProductGlweSecretKey<
            Precision,
            CiphertextIn1::KeyDistribution,
            TensorProductKey,
        >>::synthesize_tensor_product_glwe_secret_key(
            maker,
            &proto_secret_key);
