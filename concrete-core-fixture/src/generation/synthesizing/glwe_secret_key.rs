...
mod backend_default {
    use crate::generation::prototypes::{
        ProtoBinaryGlweSecretKey32, ProtoBinaryGlweSecretKey64, ProtoTensorProductGlweSecretKey32,
        ProtoTensorProductGlweSecretKey64,
    };
    use crate::generation::synthesizing::SynthesizesGlweSecretKey;
    use crate::generation::{Maker, Precision32, Precision64};
    use concrete_core::prelude::{
        DestructionEngine, GlweSecretKey32, GlweSecretKey64, GlweTensorProductSecretKey32,
...
pub trait SynthesizesTensorProductGlweSecretKey<
    Precision: IntegerPrecision,
    InputKeyDistribution: KeyDistributionMarker,
    GlweSecretKey,
>: PrototypesGlweSecretKey<Precision, InputKeyDistribution> where
    GlweSecretKey: GlweSecretKeyEntity,
{
...
mod backend_fftw {
    ...
    use concrete_core::prelude::{
        DestructionEngine, GlweSecretKeyConversionEngine, GlweSecretKeyTensorProductSameKeyEngine,
        ...
        > for Maker
    {
        fn synthesize_tensor_product_glwe_secret_key(
            ...
            let fourier_key = self
                .fftw_engine
                .create_tensor_product_glwe_secret_key_same_key(&prototype.0)
                .unwrap();
            self.fftw_engine
                .convert_glwe_secret_key(&fourier_key)
                .unwrap()
        }
