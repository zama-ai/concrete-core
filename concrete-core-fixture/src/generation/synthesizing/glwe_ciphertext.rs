...
mod backend_fftw {
    use crate::generation::prototypes::{
        ProtoBinaryGlweCiphertext32, ProtoBinaryGlweCiphertext64,
        ProtoTensorProductGlweCiphertext32, ProtoTensorProductGlweCiphertext64,
    };
    use crate::generation::synthesizing::SynthesizesGlweCiphertext;
    use crate::generation::{Maker, Precision32, Precision64};
    use concrete_core::prelude::{
    ...
    impl SynthesizesGlweCiphertext<Precision32, FftwFourierGlweTensorProductCiphertext32> for Maker {
        fn synthesize_glwe_ciphertext(
            &mut self,
    ...
    impl SynthesizesGlweCiphertext<Precision64, FftwFourierGlweTensorProductCiphertext64> for Maker {
        fn synthesize_glwe_ciphertext(
            &mut self,
            _prototype: &Self::GlweCiphertextProto,
        ...
        fn unsynthesize_glwe_ciphertext(
            ...
            ProtoTensorProductGlweCiphertext64(
                self.fftw_engine.convert_glwe_ciphertext(&entity).unwrap(),
            )
        }
