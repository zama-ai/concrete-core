...
pub struct Maker {
    ...
    fftw_parallel_engine: concrete_core::backends::fftw::engines::FftwParallelEngine,
...
impl Default for Maker {
    fn default() -> Self {
        Maker {
            ...
            #[cfg(feature = "backend_fftw_parallel")]
            fftw_parallel_engine: concrete_core::backends::fftw::engines::FftwParallelEngine::new
                (()).unwrap(),
            #[cfg(all(feature = "backend_cuda", not(feature = "_ci_do_not_compile")))]
