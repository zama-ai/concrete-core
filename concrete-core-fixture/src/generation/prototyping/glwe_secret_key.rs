...
/// A trait allowing to transmute GLWE secret key prototypes.
pub trait TransmutesGlweSecretKeyPrototype<
    Precision: IntegerPrecision,
    KeyDistribution: KeyDistributionMarker,
>: PrototypesGlweSecretKey<Precision, KeyDistribution> + PrototypesLweSecretKey<Precision, 
    KeyDistribution>
{
...
impl TransmutesGlweSecretKeyPrototype<Precision32, BinaryKeyDistribution> for Maker {
    fn transmute_glwe_secret_key_to_lwe_secret_key(
        &mut self,
        glwe_key: &Self::GlweSecretKeyProto,
    ) -> Self::LweSecretKeyProto {
...
impl TransmutesGlweSecretKeyPrototype<Precision64, BinaryKeyDistribution> for Maker {
    fn transmute_glwe_secret_key_to_lwe_secret_key(
        &mut self,
        glwe_key: &Self::GlweSecretKeyProto,
    ) -> Self::LweSecretKeyProto {
