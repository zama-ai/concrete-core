    ...
    ($fixture: ident, $precision: ident, ($($types:ident),+)) => {
        paste!{
            ...
            fn [< test_ $fixture:snake _ $precision:snake _ $($types:snake)_+ >]() {
                ...
                let mut engine = MultithreadEngine::new(()).unwrap();
                let test_result =
                    <$fixture as Fixture<
                        $precision,
                        MultithreadEngine,
...
test! {
    (LweCiphertextVectorDiscardingBootstrapFixture1, (FourierLweBootstrapKey,
        GlweCiphertextVector,
        LweCiphertextVector, LweCiphertextVector)),
    (LweCiphertextVectorDiscardingBootstrapFixture2, (FourierLweBootstrapKey,
        GlweCiphertextVector,
        LweCiphertextVector, LweCiphertextVector))
}