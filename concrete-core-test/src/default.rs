...
test! {
    ...
    ((BinaryKeyDistribution, BinaryKeyDistribution),
        LweBootstrapKeyConstructionFixture, (Vec, LweBootstrapKey)),
    ((BinaryKeyDistribution, BinaryKeyDistribution),
        LweBootstrapKeyConstructionFixture, (Slice, LweBootstrapKeyView)),
    ((BinaryKeyDistribution, BinaryKeyDistribution),
        LweBootstrapKeyConstructionFixture, (MutSlice, LweBootstrapKeyMutView)),
    ...
    ((BinaryKeyDistribution, BinaryKeyDistribution), LweCiphertextVectorGlweCiphertextDiscardingPackingKeyswitchFixture, (LweCiphertextVector, PackingKeyswitchKey, GlweCiphertext)),
    ((BinaryKeyDistribution, BinaryKeyDistribution), LweCiphertextVectorGlweCiphertextDiscardingPrivateFunctionalPackingKeyswitchFixture,
        (LweCiphertextVector, PrivateFunctionalPackingKeyswitchKey, GlweCiphertext,
            CleartextVector)),
