...
/// Convert an `LweBootstrapKey32` to an `FftFourierLweBootstrapKey32`.
///
/// Refer to `concrete-core` implementation for detailed documentation.
///
/// This function is [checked](crate#safety-checked-and-unchecked-functions).
#[no_mangle]
pub unsafe extern "C" fn fft_engine_convert_lwe_bootstrap_key_to_fft_fourier_lwe_bootstrap_key_u32(
...
/// [`fft_engine_convert_lwe_bootstrap_key_to_fft_fourier_lwe_bootstrap_key_u32`]
#[no_mangle]
pub unsafe extern "C" fn fft_engine_convert_lwe_bootstrap_key_to_fft_fourier_lwe_bootstrap_key_unchecked_u32(
    engine: *mut FftEngine,
    input: *const LweBootstrapKey32,
    result: *mut *mut FftFourierLweBootstrapKey32,
) -> c_int {
