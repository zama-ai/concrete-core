...
/// Convert an `LweBootstrapKey64` to an `FftFourierLweBootstrapKey64`.
///
/// Refer to `concrete-core` implementation for detailed documentation.
///
/// This function is [checked](crate#safety-checked-and-unchecked-functions).
#[no_mangle]
pub unsafe extern "C" fn fft_engine_convert_lwe_bootstrap_key_to_fft_fourier_lwe_bootstrap_key_u64(
...
#[no_mangle]
pub unsafe extern "C" fn fft_engine_convert_lwe_bootstrap_key_to_fft_fourier_lwe_bootstrap_key_unchecked_u64(
    engine: *mut FftEngine,
    input: *const LweBootstrapKey64,
    result: *mut *mut FftFourierLweBootstrapKey64,
) -> c_int {
