...
/// Transform an `LweSeededBootstrapKey64` into a `LweBootstrapKey64`.
///
/// The passed `LweSeededBootstrapKey64` is consumed and cannot be accessed afterwards, the passed
...
#[no_mangle]
pub unsafe extern "C" fn default_engine_transform_lwe_seeded_bootstrap_key_to_lwe_bootstrap_key_u64(
    engine: *mut DefaultEngine,
    lwe_seeded_bootstrap_key: *mut *mut LweSeededBootstrapKey64,
...
/// [`default_engine_transform_lwe_seeded_bootstrap_key_to_lwe_bootstrap_key_u64`]
#[no_mangle]
pub unsafe extern "C" fn default_engine_transform_lwe_seeded_bootstrap_key_to_lwe_bootstrap_key_unchecked_u64(
    engine: *mut DefaultEngine,
    lwe_seeded_bootstrap_key: *mut *mut LweSeededBootstrapKey64,
    result: *mut *mut LweBootstrapKey64,
) -> c_int {
