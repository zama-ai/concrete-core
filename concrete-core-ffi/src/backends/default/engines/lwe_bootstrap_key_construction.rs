...
//! `LweBootstrapKeyConstructionEngine` traits.
...
#[no_mangle]
pub unsafe extern "C" fn default_engine_construct_lwe_bootstrap_key_mut_view_u64(
...
/// [`default_engine_construct_lwe_bootstrap_key_mut_view_u64`]
#[no_mangle]
pub unsafe extern "C" fn default_engine_construct_lwe_bootstrap_key_mut_view_unchecked_u64(
    engine: *mut DefaultEngine,
    input: *mut u64,
    lwe_dimension: usize,
    glwe_size: usize,
    ...
    catch_panic(|| {
        ...
        *result = std::ptr::null_mut();
        ...
        let heap_allocated_lwe_bootstrap_key_mut_view =
            Box::new(engine.construct_lwe_bootstrap_key_unchecked(
                input_container,
                GlweSize(glwe_size),
                PolynomialSize(poly_size),
                DecompositionBaseLog(decomposition_base_log),
