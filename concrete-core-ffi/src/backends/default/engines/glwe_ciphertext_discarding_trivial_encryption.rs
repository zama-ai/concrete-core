...
pub unsafe extern "C" fn default_engine_discard_trivially_encrypt_glwe_ciphertext_u64_view_buffers(
    ...
    catch_panic(|| {
        ...
        let plaintext_vector = engine
            .create_plaintext_vector(input_as_slice)
...
pub unsafe extern "C" fn default_engine_discard_trivially_encrypt_glwe_ciphertext_unchecked_u64_view_buffers(
    ...
    catch_panic(|| {
        ...
        let plaintext_vector = engine.create_plaintext_vector_unchecked(input_as_slice);
...
pub unsafe extern "C" fn default_engine_discard_trivially_encrypt_glwe_ciphertext_u64_raw_ptr_buffers(
    ...
    catch_panic(|| {
        ...
        let mut output = engine
            .create_glwe_ciphertext(output_as_slice, PolynomialSize(polynomial_size))
            .or_else(engine_error_as_readable_string)
            .unwrap();
...
pub unsafe extern "C" fn default_engine_discard_trivially_encrypt_glwe_ciphertext_unchecked_u64_raw_ptr_buffers(
    ...
    catch_panic(|| {
        ...
        let output_as_slice = std::slice::from_raw_parts_mut(output, output_buffer_size);
        let mut output = engine
            .create_glwe_ciphertext_unchecked(output_as_slice, PolynomialSize(polynomial_size));
