...
/// Generate a new `LweKeyswitchKey32`.
///
/// Refer to `concrete-core` implementation for detailed documentation.
///
/// This function is [checked](crate#safety-checked-and-unchecked-functions).
#[no_mangle]
pub unsafe extern "C" fn default_engine_generate_new_lwe_keyswitch_key_u32(
...
/// [`default_engine_generate_new_lwe_keyswitch_key_u32`]
#[no_mangle]
pub unsafe extern "C" fn default_engine_generate_new_lwe_keyswitch_key_unchecked_u32(
    engine: *mut DefaultEngine,
    input_key: *const LweSecretKey32,
    output_key: *const LweSecretKey32,
    decomp_level_count: usize,
