...
/// Create a `GlweCiphertextView32`.
///
/// Refer to `concrete-core` implementation for detailed documentation.
///
/// This function is [checked](crate#safety-checked-and-unchecked-functions).
#[no_mangle]
pub unsafe extern "C" fn default_engine_create_glwe_ciphertext_view_from_u32(
    engine: *mut DefaultEngine,
    input: *const u32,
    input_buffer_size: usize,
    polynomial_size: usize,
    result: *mut *mut GlweCiphertextView32,
) -> c_int {
    catch_panic(|| {
...
/// [`default_engine_create_glwe_ciphertext_view_from_u32`]
#[no_mangle]
pub unsafe extern "C" fn default_engine_create_glwe_ciphertext_view_from_unchecked_u32(
    engine: *mut DefaultEngine,
    input: *const u32,
    glwe_size: usize,
    polynomial_size: usize,
...
/// Create a `GlweCiphertextMutView32`.
///
/// Refer to `concrete-core` implementation for detailed documentation.
///
/// This function is [checked](crate#safety-checked-and-unchecked-functions).
#[no_mangle]
pub unsafe extern "C" fn default_engine_create_glwe_ciphertext_mut_view_from_u32(
    engine: *mut DefaultEngine,
    input: *mut u32,
    glwe_size: usize,
    polynomial_size: usize,
    result: *mut *mut GlweCiphertextMutView32,
) -> c_int {
    catch_panic(|| {
        check_ptr_is_non_null_and_aligned(result).unwrap();
...
/// [Unchecked](crate#safety-checked-and-unchecked-functions) version of
/// [`default_engine_create_glwe_ciphertext_mut_view_from_u32`]
#[no_mangle]
pub unsafe extern "C" fn default_engine_create_glwe_ciphertext_mut_view_from_unchecked_u32(
    engine: *mut DefaultEngine,
    input: *mut u32,
    glwe_size: usize,
    polynomial_size: usize,
