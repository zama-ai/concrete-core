...
/// Create an `LweCiphertextVectorView64` from a raw pointer.
///
/// Refer to `concrete-core` implementation for detailed documentation.
///
/// This function is [checked](crate#safety-checked-and-unchecked-functions).
#[no_mangle]
pub unsafe extern "C" fn default_engine_create_lwe_ciphertext_vector_view_from_u64(
    engine: *mut DefaultEngine,
    input: *const u64,
    lwe_size: usize,
    lwe_count: usize,
    result: *mut *mut LweCiphertextVectorView64,
) -> c_int {
    catch_panic(|| {
...
/// [`default_engine_create_lwe_ciphertext_vector_view_from_u64`]
#[no_mangle]
pub unsafe extern "C" fn default_engine_create_lwe_ciphertext_vector_view_from_unchecked_u64(
    engine: *mut DefaultEngine,
    input: *const u64,
    lwe_size: usize,
    lwe_count: usize,
...
/// Create an `LweCiphertextVectorMutView64` from a raw pointer.
///
/// Refer to `concrete-core` implementation for detailed documentation.
///
/// This function is [checked](crate#safety-checked-and-unchecked-functions).
#[no_mangle]
pub unsafe extern "C" fn default_engine_create_lwe_ciphertext_vector_mut_view_from_u64(
    engine: *mut DefaultEngine,
    input: *mut u64,
    lwe_size: usize,
    lwe_count: usize,
    result: *mut *mut LweCiphertextVectorMutView64,
) -> c_int {
    catch_panic(|| {
        check_ptr_is_non_null_and_aligned(result).unwrap();
...
/// [Unchecked](crate#safety-checked-and-unchecked-functions) version of
/// [`default_engine_create_lwe_ciphertext_vector_mut_view_from_u64`]
#[no_mangle]
pub unsafe extern "C" fn default_engine_create_lwe_ciphertext_vector_mut_view_from_unchecked_u64(
    engine: *mut DefaultEngine,
    input: *mut u64,
    lwe_size: usize,
    lwe_count: usize,
