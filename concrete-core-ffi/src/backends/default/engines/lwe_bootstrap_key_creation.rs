...
//! of various `LweBootstrapKeyCreationEngine` traits.

use crate::utils::*;
use concrete_core::prelude::*;
use std::os::raw::c_int;

/// Create an `LweBootstrapKey64` with a `DefaultEngine`.
///
/// Refer to `concrete-core` implementation for detailed documentation.
///
/// This function is [checked](crate#safety-checked-and-unchecked-functions).
#[no_mangle]
pub unsafe extern "C" fn default_engine_create_lwe_bootstrap_key_u64(
...
/// [`default_engine_create_lwe_bootstrap_key_u64`]
#[no_mangle]
pub unsafe extern "C" fn default_engine_create_lwe_bootstrap_key_unchecked_u64(
    engine: *mut DefaultEngine,
    input_key: *const LweSecretKey64,
    output_key: *const GlweSecretKey64,
    decomposition_base_log: usize,
    ...
    catch_panic(|| {
        ...
        *result = std::ptr::null_mut();
        ...
        let heap_allocated_bsk = Box::new(engine.create_lwe_bootstrap_key_unchecked(
            input_key,
            output_key,
            DecompositionBaseLog(decomposition_base_log),
            DecompositionLevelCount(decomposition_level_count),
...
/// Create an `LweBootstrapKey64` with a `DefaultParallelEngine`.
///
/// Refer to `concrete-core` implementation for detailed documentation.
///
/// This function is [checked](crate#safety-checked-and-unchecked-functions).
