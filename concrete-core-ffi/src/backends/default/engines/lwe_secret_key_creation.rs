...
//! `LweSecretKeyCreationEngine` traits.

use crate::utils::*;
use concrete_core::prelude::*;
use std::os::raw::c_int;

/// Create an `LweSecretKey64`.
///
    ...
    catch_panic(|| {
        ...
        *result = std::ptr::null_mut();
        ...
        let heap_allocated_secret_key = Box::new(
            engine
                .create_lwe_secret_key(LweDimension(dimension))
...
pub unsafe extern "C" fn default_engine_create_lwe_secret_key_unchecked_u64(
    ...
    catch_panic(|| {
        ...
        *result = std::ptr::null_mut();
        ...
        let heap_allocated_secret_key =
            Box::new(engine.create_lwe_secret_key_unchecked(LweDimension(dimension)));
        *result = Box::into_raw(heap_allocated_secret_key);
    })
}
